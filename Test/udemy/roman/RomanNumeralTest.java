...
public class RomanNumeralTest {
	...
	public void aComposedNumberWithRegression() {
		...
		Assert.assertEquals(18, roman.convert("XVIII"));
		Assert.assertEquals(14, roman.convert("XIV"));
	}
	
	@Test
	public void bigNumbersComposed() {
		Assert.assertEquals(1398, roman.convert("MCCCXCVIII"));
		Assert.assertEquals(3489, roman.convert("MMMCDLXXXIX"));
	}
}
